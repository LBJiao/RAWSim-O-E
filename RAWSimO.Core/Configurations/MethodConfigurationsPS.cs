...
namespace RAWSimO.Core.Configurations
{
    ...
    /// The configuration for the corresponding method.
    /// </summary>
    public class GM_1PodStorageConfiguration : PodStorageConfiguration
    {
        /// <summary>
        /// Returns the type of the corresponding method this configuration belongs to.
        /// </summary>
        /// <returns>The type of the method.</returns>
        public override PodStorageMethodType GetMethodType() { return PodStorageMethodType.GM_1; }
        /// <summary>
        /// Returns a name identifying the method.
        /// </summary>
        /// <returns>The name of the method.</returns>
        public override string GetMethodName()
        {
            ...
            switch (PodDisposeRule)
            {
                case GM_1PodStorageLocationDisposeRule.Euclid: name += "e"; break;
                case GM_1PodStorageLocationDisposeRule.Manhattan: name += "m"; break;
                case GM_1PodStorageLocationDisposeRule.ShortestPath: name += "s"; break;
                case GM_1PodStorageLocationDisposeRule.ShortestTime: name += "t"; break;
                default: throw new ArgumentException("Unexpected argument!");
            }
            return name;
        }
        ...
        /// Indicates which distance metric is used to select a free pod storage location.
        /// </summary>
        public GM_1PodStorageLocationDisposeRule PodDisposeRule = GM_1PodStorageLocationDisposeRule.ShortestTime;
    }
    /// <summary>
    /// The configuration for the corresponding method.
    /// </summary>
