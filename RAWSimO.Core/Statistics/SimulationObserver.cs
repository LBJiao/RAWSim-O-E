...
namespace RAWSimO.Core.Statistics
{
    ...
    public class SimulationObserver : IUpdateable
    {
        ...
        /// </summary>
        public double TimingOrderBatchingbyMPOverall { get { return _timingOrderBatchingbyMPOverall; } }
        /// <summary>
        /// The average time consumed for making a single decision.
        /// </summary>
        ...
        /// The average time consumed for making a single decision.
        /// </summary>
        public double TimingOrderBatchingbyMPAverage { get { return _timingOrderBatchingCount == 0 ? 0 : _timingOrderBatchingbyMPOverall / _timingOrderBatchingbyMPCount; } }
        /// <summary>
