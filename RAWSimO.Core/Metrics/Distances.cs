...
namespace RAWSimO.Core.Metrics
{
    ...
    public class Distances
    {
        ...
        {
            return instance.MetaInfoManager.ShortestPathManager.GetShortestPath1(from, to, instance.WrongTierPenaltyDistance, true);
        }
        /// <summary>
        /// Calculates the shortest path from the first to the second waypoint avoiding pod storage locations.
        /// </summary>
        ...
        public static double CalculateManhattan1(Circle c1, Circle c2) { return Math.Abs(c1.X - c2.X) + Math.Abs(c1.Y - c2.Y); }
    }
}
